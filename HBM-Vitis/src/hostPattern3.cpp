...
const int pc[32] = {
    PC_NAME(8),  PC_NAME(3),  PC_NAME(19),  PC_NAME(29),  PC_NAME(27),  PC_NAME(16),  PC_NAME(10),  PC_NAME(14),
    PC_NAME(7),  PC_NAME(26),  PC_NAME(13), PC_NAME(20), PC_NAME(12), PC_NAME(24), PC_NAME(25), PC_NAME(6),
    PC_NAME(18), PC_NAME(23), PC_NAME(4), PC_NAME(2), PC_NAME(0), PC_NAME(22), PC_NAME(9), PC_NAME(30),
    PC_NAME(28), PC_NAME(17), PC_NAME(21), PC_NAME(5), PC_NAME(1), PC_NAME(11), PC_NAME(15), PC_NAME(31)};
...
int main(int argc, char *argv[]) {
	...
	unsigned int dataSize = 1048576*64;//256 MB
