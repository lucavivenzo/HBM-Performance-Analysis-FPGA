...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200200024 -s 4
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200210024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x2002c0010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x2002c001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2002c0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200370010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20037001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200370024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200390010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20039001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200390024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x2003a0010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x2003a001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2003a0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2003b0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2003c0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2003d0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x2003e0010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x2003e001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2003e0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200220024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200230010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20023001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200230024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200240024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200250010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20025001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200250024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200260010 -s 4
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20026001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200260024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200270024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200280024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200290024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x2002a0010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x2002a001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2002a0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x2002b0010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x2002b001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2002b0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x2002d0010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x2002d001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2002d0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2002e0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x2002f0010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x2002f001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x2002f0024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200300024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200310024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200320024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200330024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200340010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20034001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200340024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200350010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20035001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200350024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200360010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20036001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200360024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
...
sudo ./dma_to_device -f temp.bin -a 0x200380010 -s 6
echo 'Setting the size...'
sudo ./dma_to_device -f send256MB.bin -a 0x20038001c -s 4
echo 'Choosing the write operation...'
sudo ./dma_to_device -f bit0High.bin -a 0x200380024 -s 4
#echo 'Choosing the read operation...'
#dovrebbe essere già 0
echo 'Global Interrupt enable'
